      ...
      <nav className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <ul className="hidden md:flex items-center gap-8 list-none m-0 p-0">
          ...
          <li>
            <Link
              href="/book"
              className="bg-brand-gold text-black px-4 py-2 rounded text-sm font-medium hover:bg-brand-gold-dark transition-colors"
            >
              Book a Session
            </Link>
          </li>
          ...
          <ul className="list-none m-0 p-0 px-6 py-4 flex flex-col gap-1">
            ...
            <li className="pt-3">
              <Link
                href="/book"
                onClick={() => setOpen(false)}
                className="block w-full text-center bg-brand-gold text-black px-4 py-3 rounded text-sm font-medium hover:bg-brand-gold-dark transition-colors"
              >
                Book a Session
              </Link>
            </li>
