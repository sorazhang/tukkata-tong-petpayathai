      ...
      <div className="flex flex-col gap-2">
        {question.options.map((opt) => (
          <button
            ...
            className="text-left px-4 py-3 rounded-lg border border-gray-200 text-sm text-brand-black hover:border-brand-clay hover:text-brand-red transition-all duration-150 font-medium"
          >
            {opt.label}
          </button>
        ))}
