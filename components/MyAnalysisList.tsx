    ...
    <div className="border border-brand-card-edge rounded-xl overflow-hidden">
      ...
      >
        ...
        <div className="flex items-center gap-2 shrink-0">
          <span className="text-xs text-brand-bone-dim">{analysis.entryCount} entries</span>
          <span
            className="text-brand-bone-dim text-lg leading-none"
      ...
      {expanded && (
        <div className="px-4 pb-4 border-t border-brand-card-edge pt-3 space-y-4">
          ...
          {analysis.progress && (
            <div className="p-3 bg-amber-50 rounded-lg border border-amber-100">
              ...
              <p className="text-sm text-brand-bone leading-relaxed">{analysis.progress}</p>
            </div>
          )}
          ...
          <div className="p-3 bg-brand-red/5 rounded-lg border border-brand-red/10">
            ...
            <p className="text-sm text-brand-bone leading-relaxed">{analysis.suggestion}</p>
          </div>
